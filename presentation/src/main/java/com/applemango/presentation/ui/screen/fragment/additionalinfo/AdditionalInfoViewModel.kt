package com.applemango.presentation.ui.screen.fragment.additionalinfo

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.applemango.domain.usecaseImpl.user.RegisterUserUseCase
import com.applemango.domain.usecaseImpl.user.local.GetDeviceTokenUseCase
import com.applemango.domain.usecaseImpl.user.local.GetUuidUseCase
...
import com.applemango.presentation.ui.model.NewUserModel
                    ...
                    getJobTag()?.let { job ->
                        val result: NewUserModel? = try {
                            val registerResult = registerUserUseCase(
                                RegisterUserUseCase.JoinUserParam(
                                    uuid = uuid,
