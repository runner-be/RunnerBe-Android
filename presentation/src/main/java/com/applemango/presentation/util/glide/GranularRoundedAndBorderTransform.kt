package com.applemango.presentation.util.glide
...
class GranularRoundedAndBorderTransform @Inject constructor(
    ...
    private fun transformBitmap(source: Bitmap): Bitmap {
        ...
        val borderPaint = Paint().apply {
            isAntiAlias = true
            color = ContextCompat.getColor(context, strokeColorResource)
